...
object WhatsAFunction:
  ...
  /* FP: functions are "first-class" citizens, i.e. work with functions like any
   * other values */
  /* JVM was built for Java, an OO language: objects (instances of classes) are
  ...
  // larger example
  /* (Int, String, Double, Boolean) => Int, aka Function4[Int, String, Double,
   * Boolean, Int] */
  ...
  /* all function values in Scala are instances of FunctionN traits with apply
   * methods */

  /**
   * Exercises
   *   1. A function which takes 2 strings and concatenates them
   *   2. Replace Predicate/Transformer with the appropriate function types if
   *      necessary
   *   3. Define a function which takes an int as argument and returns ANOTHER
  ...
  def main(args: Array[String]): Unit = println(concatenator("I love ", "Scala"))
end WhatsAFunction

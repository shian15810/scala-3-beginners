...
object AllThePatterns:
  ...
  val isEven_bad_v2 = if aSimpleInt % 2 == 0 then true else false
  ...
  /* PM runs at runtime
   * - reflection
   * - generic types are erased at runtime List[String] => List List[Int] =>
   * List Function1[Int, String] => Function1 etc. */

  def main(args: Array[String]): Unit = println(numbersMatch)
end AllThePatterns

...
object Objects:
  ...
  /* methods and fields in objects are used for instance-independent
  ...
  //
  /* Scala application:
   * object Objects { def main(args: Array[String]): Unit = { ... } }
   *
   * Equivalent Java application:
   * public class Objects { public static void main(String[] args) { ... } } */
  def main(args: Array[String]): Unit = println(sameMary_v3)
end Objects

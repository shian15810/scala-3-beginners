...
object AccessModifiers:
  ...
  class Person(val name: String):
    ...
    private def watchNetflix(): String =
      "I'm binge watching my favorite series..."
  ...
  class KidWithParents(
    ...
    /* this.sayHi() + s"Hi, I'm $name, and here are my parents: " + mom.sayHi()
     * + dad.sayHi() */

  def main(args: Array[String]): Unit = println(aKid.greetPolitely())
end AccessModifiers
